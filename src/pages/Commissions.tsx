...
import { CommissionPeriodsTable } from "@/components/commissions/commission-periods-table";
import { AdjustmentHistoryPage } from "@/components/commissions/adjustment-history-page";
import logoImage from "@/assets/theon-logo.avif";
import { Construction } from "lucide-react";

const Commissions = () => {
  const [view, setView] = useState<"periods" | "adjustments">("periods");
      ...
      <div className="min-h-screen flex w-full bg-dashboard-bg">
        ...
        <div className="flex-1 flex flex-col w-full">
          ...
          <main className="flex-1 p-4 md:p-6">
            {view === "periods" ? (
              <CommissionPeriodsTable onViewAdjustments={() => setView("adjustments")} />
            ) : (
              <AdjustmentHistoryPage onBack={() => setView("periods")} />
            )}
          </main>
